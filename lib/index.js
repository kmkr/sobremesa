...
app.get("/", async (req, res) => {
  ...
  return res.render("index", {
    ...
    assets: JSON.stringify({
      arrowDown: `/assets/arrow-down.png?${hashStore.withHash(
        path.join("..", "assets", "arrow-down.png")
      )}`,
      iceCream: `/assets/icecream-486.png?${hashStore.withHash(
        path.join("..", "assets", "icecream-486.png")
      )}`
    }),
    user,
    missingUser
